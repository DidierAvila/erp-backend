...
namespace ERP.Application.Core.Auth.Commands.Authentication
{
    public class LoginCommand : ILoginCommand
    {
        ...
        public LoginCommand(IRepositoryBase<User> userRepository, IRepositoryBase<Session> sessionRepository, IConfiguration configuration, ILogger<LoginCommand> logger, IRepositoryBase<Domain.Entities.Auth.UserTypes> userTypeRepository, IUserRoleRepository userRoleRepository, IRolePermissionRepository rolePermissionRepository, IRepositoryBase<Permission> permissionRepository) 
        {
