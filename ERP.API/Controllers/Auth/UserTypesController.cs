...
namespace ERP.API.Controllers.Auth
{
    ...
    public class UserTypesController : ControllerBase
    {
        ...
        public UserTypesController(IUserTypeCommandHandler commandHandler, IUserTypeQueryHandler queryHandler)
        {
        ...
        /// </summary>
        [HttpGet]
        public async Task<ActionResult<IEnumerable<UserTypeDto>>> GetAllUserTypes(CancellationToken cancellationToken)
        {
